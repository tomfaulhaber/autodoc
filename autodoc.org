...
**** TODO Define a new branch spec that has real version info in addition to branch name
For instance "(latest stable release)" or "(active development branch)"
**** TODO Fix left-hand TOC to be clearer
**** TODO Add version info to page header and title
See python docs for a good example

*** Add categories to clojure.core functions
*** Add pointer back into clojure.core
**** TODO Add pointer back to clojure.org root from the top of the left-hand TOC
...
*** TODO Supress author tag when none provided
