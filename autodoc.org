...
*** TODO Add index.clj files to all projects
*** TODO Extend index data to include all metadata information
** Bugs
...
*** TODO Some source link (see clojure.contrib.accumulators/add) don't seem to be working right.
